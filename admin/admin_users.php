...
<head>
  ...
  <style>
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    body.light .sidebar-card, body.light .filter-bar, body.light .user-row { background:#FFFFFF; border-color:#E0CECA; }
    body.light .sb-stat, body.light .pill-opt { background:#F5EEEC; border-color:#E0CECA; }
    ...
    <aside class="sidebar anim">
      <div class="sidebar-card">
        ...
        <div class="sidebar-stats">
          <div class="sb-stat"><div class="sb-stat-num"><?php echo count($users); ?></div><div class="sb-stat-lbl">Showing</div></div>
        ...
        <a class="sb-nav-item active" href="admin_users.php"><i class="fas fa-users"></i> User Accounts</a>
