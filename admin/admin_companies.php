...
<head>
  ...
  <style>
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    .cc-name { font-family:var(--font-display); font-size:16px; font-weight:700; color:var(--text-light); margin-bottom:3px; }
    ...
    @media(max-width:760px) { .nav-links{display:none} .hamburger{display:flex} .profile-wrap{display:none} .nav-inner{padding:0 10px} .page-shell{padding:0 16px 60px} .theme-btn,.notif-btn-nav{width:32px;height:32px;font-size:13px} .nav-right{gap:6px} .cc-top{flex-direction:column} .cc-actions{flex-direction:row} }
  </style>
</head>
<body>
