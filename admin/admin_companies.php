  ...
  <div class="content-layout">
    ...
    <aside class="sidebar anim">
      <div class="sidebar-card">
        ...
        <a class="sb-nav-item active" href="admin_companies.php"><i class="fas fa-building"></i> Company Approval <?php if($pendingCount > 0): ?><span class="sb-badge"><?php echo $pendingCount; ?></span><?php endif; ?></a>
        <a class="sb-nav-item" href="admin_jobs.php"><i class="fas fa-briefcase"></i> Job Moderation <?php if($pendingJobsCount > 0): ?><span class="sb-badge amber"><?php echo $pendingJobsCount; ?></span><?php endif; ?></a>
