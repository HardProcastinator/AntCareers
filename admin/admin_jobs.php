...
<head>
  ...
  <style>
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    @media(max-width:760px) { .nav-links{display:none} .hamburger{display:flex} .profile-wrap{display:none} .nav-inner{padding:0 10px} .page-shell{padding:0 16px 60px} .theme-btn,.notif-btn-nav{width:30px;height:30px;font-size:12px} .nav-right{gap:6px} .jr-layout{grid-template-columns:1fr;gap:10px} }
  </style>
</head>
<body>
