...
<head>
  ...
  <style>
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    .td-name { font-weight:700; color:var(--text-light); font-size:13px; }
    ...
    .modal-textarea { width:100%; padding:12px 14px; background:var(--soil-hover); border:1px solid var(--soil-line); border-radius:8px; color:var(--text-light); font-family:var(--font-body); font-size:13px; resize:vertical; min-height:96px; outline:none; transition:0.2s; }
    ...
    @media(max-width:760px) { .nav-links{display:none} .hamburger{display:flex} .profile-wrap{display:none} .nav-inner{padding:0 10px} .page-shell{padding:0 16px 60px} .theme-btn,.notif-btn-nav{width:32px;height:32px;font-size:13px} .nav-right{gap:6px} .jr-layout{grid-template-columns:1fr;gap:10px} }
  </style>
</head>
<body>
<div class="tunnel-bg">
...
<nav class="navbar">
  <div class="nav-inner">
    ...
    <div class="nav-links">
      ...
      <a class="nav-link active" href="admin_jobs.php"><i class="fas fa-briefcase"></i> Jobs<?php if($adminPendingJobs>0): ?> <span style="background:var(--red-vivid);color:#fff;font-size:10px;font-weight:700;border-radius:8px;padding:1px 6px;"><?php echo $adminPendingJobs; ?></span><?php endif; ?></a>
...
<div class="mobile-menu" id="mobileMenu">
  ...
  <a class="mobile-link active" href="admin_jobs.php"><i class="fas fa-briefcase"></i> Job Moderation</a>
        ...
        <div class="filter-form">
          ...
          <div class="filter-group" style="flex:1;min-width:220px;">
            ...
            <div style="position:relative;">
              ...
              <input class="search-input" id="jobSearch" type="text" autocomplete="off" placeholder="Search jobs, company, location…" style="padding-left:32px;width:100%;" oninput="filterJobs(this.value)">
            </div>
          </div>
        </div>
      </div><!-- /filter-bar -->
