      ...
      <form class="filter-bar" method="GET" action="">
        <div class="filter-form">
          <div class="filter-group">
            ...
            <input class="filter-input" type="text" name="q" value="<?php echo htmlspecialchars($search, ENT_QUOTES); ?>" placeholder="User name or description…" style="min-width:200px;">
          </div>
          <div class="filter-group">
