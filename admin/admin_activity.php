...
<head>
  ...
  <style>
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    .filter-input { padding:8px 12px; background:var(--soil-hover); border:1px solid var(--soil-line); border-radius:7px; color:var(--text-light); font-family:var(--font-body); font-size:13px; outline:none; transition:0.2s; }
    ...
    .filter-select { padding:8px 12px; background:var(--soil-hover); border:1px solid var(--soil-line); border-radius:7px; color:var(--text-light); font-family:var(--font-body); font-size:13px; outline:none; cursor:pointer; min-width:160px; }
    ...
    .td-user { font-weight:600; color:var(--text-light); font-size:12px; }
    ...
    .page-link:hover { color:var(--text-light); border-color:rgba(209,61,44,0.4); }
