...
<script>
  ...
  function clearForm(){['fLoc','fSMin','fSMax','fSkills','fDesc','fReq','fDl','fTitleCustom'].forEach(function(id){document.getElementById(id).value='';});document.getElementById('fTitleCustom').style.display='none';document.getElementById('fType').value='Full-time';document.getElementById('fSetup').value='On-site';document.getElementById('fExp').value='';document.getElementById('fInd').value='';updateJobTitleOptions();}
