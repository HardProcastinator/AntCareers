...
<head>
  ...
  <style>
    ...
    *,*::before,*::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    /* ── SUMMARY CARDS ROW ── */
    .cards-row { display:grid; grid-template-columns:repeat(4,1fr); gap:10px; margin-bottom:16px; }
    ...
    .featured-card { background:var(--soil-card); border:1px solid var(--soil-line); border-radius:12px; padding:18px; min-width:260px; max-width:260px; cursor:pointer; transition:all 0.25s; position:relative; overflow:hidden; flex-shrink:0; }
